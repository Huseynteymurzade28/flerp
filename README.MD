...
true pixels or an approximation.
...
The application is organized into six modes:
...
3. `Viewer`
   Scrollable file content view. For PDFs it also reports the current page and
   how many images sit on it.
4. `Analyze`
